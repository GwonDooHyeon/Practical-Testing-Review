...
import sample.cafekioskreview.spring.api.service.mail.MailService;
...
public class OrderStatisticsService {
    ...
    public boolean sendOrderStatisticsMail(LocalDate orderDate, String email) {
        ...
        // 메일 전송
        boolean result = mailService.sendMail("no-reply@cakekiosk.com",
            email,
            "[매출통계] %s".formatted(orderDate),
            "총 매출 합계는 %s원입니다.".formatted(totalAmount));
